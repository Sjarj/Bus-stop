...
public class Canvas: UIView {
    ...
    public func createRoadSection() {
        let roadSectionView = RoadSectionView(origin: getOrigin(),
    ...
    public func createSchoolRoadSection() {
        let roadSectionView = SchoolRoadSectionView(origin: getOrigin(),
                                                    direction: getCurrentDirection(),
                                                    corner: getCorner())
    ...
    public func createHomeRoadSection() {
        let roadSectionView = HomeRoadSectionView(origin: getOrigin(),
                                                  direction: getCurrentDirection(),
                                                  corner: getCorner())
        roadSectionView.layer.zPosition = 10
        append(section: roadSectionView)
    ...
    private func getTransform() -> CGAffineTransform {
        if let direction: Direction = getSectionDirection(at: busPosition) {
            switch direction {
            case .right:
